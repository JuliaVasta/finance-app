...
export const transactionTypeOptions = [
  { value: transactionTypes.income, label: transactionTypeLabels[transactionTypes.income] },
  { value: transactionTypes.outcome, label: transactionTypeLabels[transactionTypes.outcome] }
]
...
export const incomeTypeOptions = [
  ...
  { value: incomeTypes.interest, label: incomeTypeLabels[incomeTypes.interest] }
]

export const outcomeTypeOptions = [
  { value: outcomeTypes.expenses, label: outcomeTypeLabels[outcomeTypes.expenses] },
  { value: outcomeTypes.entertainment, label: outcomeTypeLabels[outcomeTypes.entertainment] },
  { value: outcomeTypes.grocery, label: outcomeTypeLabels[outcomeTypes.grocery] }
]
